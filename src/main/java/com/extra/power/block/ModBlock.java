...
public class ModBlock {
    ...
    public static final BlockEntry<? extends Block> SULFUR_BLOCK = REGISTRATE.block("sulfur_block", Block::new)
            ...
            .recipe((ctx, provider) -> {
                ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ctx.get())
                        ...
                        .unlockedBy("hasitem", AnvilCraftDatagen.has(com.extra.power.init.ModItemTags.SULFUR))
                        .save(provider);
            })
            .register();
    ...
    public static final BlockEntry<? extends Block> MAGNESIUM_BLOCK = REGISTRATE.block("magnesium_block", MagnesiumBlock::new)
            ...
            .recipe((ctx, provider) -> {
                ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ctx.get())
                        ...
                        .unlockedBy("hasitem", AnvilCraftDatagen.has(com.extra.power.init.ModItemTags.MAGNESIUM_INGOTS))
                        .save(provider);
            })
            .register();
    ...
    public static final BlockEntry<? extends Block> PEDOMETER = REGISTRATE.block("pedometer",
            ...
            .lang("Pedometer")
            .initialProperties(() -> Blocks.NETHERITE_BLOCK)
            .properties(p -> p.strength(2f, 3f)
                    .lightLevel(state -> state.getValue(PedometerBlock.PROGRESS) != 0 ? 9 : 0))
            .blockstate(DataGenUtil::noExtraModelOrState)
            .item()
            .build()
            .register();
