    ...
    public static final ItemEntry<Item> MAGNESIUM_INGOT = REGISTRATE.item("magnesium_ingot", Item::new)
            ...
            .recipe((ctx, provider) -> {
                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                        ...
                        .unlockedBy("hasitem", AnvilCraftDatagen.has(ModItems.MAGNESIUM_NUGGET.get()))
                        .unlockedBy("hasitemblock", AnvilCraftDatagen.has(MAGNESIUM_BLOCK))
    ...
    public static final ItemEntry<Item> SULFUR = REGISTRATE.item("sulfur", Item::new)
            ...
            .recipe((ctx, provider) -> {
                ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ctx.get(), 9)
                        ...
                        .group(ctx.getId().toString())
                        .unlockedBy("hasitemblock", AnvilCraftDatagen.has(SULFUR_BLOCK))
                        .save(provider);
            })
            .register();
    ...
    public static final ItemEntry<EmptyLeadacidBatteryItem> LEAD_ACID_BATTERY_EMPTY = REGISTRATE.item("lead_acid_battery_empty", EmptyLeadacidBatteryItem::new)
            ...
            .recipe((ctx, provider) -> {
                ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ctx.get())
                        ...
                        .group(ctx.getId().toString())
                        .unlockedBy("hasiteml", AnvilCraftDatagen.has(ModItems.SULFURIC_ACID))
