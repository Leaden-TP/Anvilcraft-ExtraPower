package com.extra.power.client.entity;
...
@OnlyIn(Dist.CLIENT)
public class TechnicalArrowRender<T extends TechnicalArrowEntity> extends ArrowRenderer<T> {
    ...
    public TechnicalArrowRender(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public ResourceLocation getTextureLocation(TechnicalArrowEntity technicalArrowEntity) {
